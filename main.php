          ...
          echo "" ?> <tr id="<?php echo $ind; ?>">
            <td>
              <div id="listR">
                ...
                <div id="rightStart">
            <td>
              <button id="#bt<?php echo $ind; ?>" onclick="importantAjax('<?php echo $ind; ?>')" id="imp" class="btn btn-danger"><i class='material-icons'>star_border</i></button>
            </td>
